...
@Component({
    components: {
        ...
        FilterTable: () => import(/* webpackChunkName: "components" */ "@/components/FilterTable.vue"),
        Record,
    },
    data: () => {
        return {
...
export default class Timetable extends Vue {
    ...
    @State(state => state.calendar.listVenueObject) halls!: [{ id: number; name: string; }];
    ...
    @State(state => state.calendar.currentVenue) actualVenue!: any;
